...
# Backwards compatibility with Legacy-GAP
if not IsBound(SynchronisationFamily) then
  BindGlobal("SynchronizationFamily", NewFamily("SynchronizationFamily", IsObject));
fi;
